...
function createBot (options = {}) {
  ...
  function next () {
    ...
    // Emit inject_allowed synchronously - plugins MUST be loaded before packets arrive
    // Do NOT use setTimeout here - it causes a race condition where registry_data packets
    // arrive before handlers are registered
