...
function inject (bot, { physicsEnabled, maxCatchupTicks }) {
  ...
  function sendPacketPosition (position, onGround) {
    ...
    lastSent.flags = { onGround, hasHorizontalCollision: bot.entity.isCollidedHorizontally ?? false } // 1.21.3+
  ...
  function updatePosition (now) {
    ...
    if (positionUpdated && lookUpdated) {
      ...
      bot._client.write('flying', {
        ...
        flags: { onGround: bot.entity.onGround, hasHorizontalCollision: bot.entity.isCollidedHorizontally ?? false } // 1.21.3+
      })
    }
