...
function inject (bot) {
  ...
  // Note: sync_entity_position sends yaw/pitch in degrees (not bytes like other packets)
  // so we use fromNotchianYaw/Pitch instead of fromNotchianYawByte/PitchByte
